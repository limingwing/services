    ...
    public static class RequestEx
    {
        ...
        public static string GetApplicationRootUrl(HttpRequest request = null)
        {
            ...
            if (request != null)
            {
                ...
                string absoluteUri = request.Url.AbsoluteUri;		//当前页面的完整uri，例如“http://www.zizaifan.com/default.html”
                ...
                string websiteUrl = absoluteUri.Substring(0, pos);	//当前页所在的站点根路径，例如“http://www.zizaifan.com”
