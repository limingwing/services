<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Meterial.aspx.cs" Inherits="Example_Meterial" %>
...
<body>
    ...
    <div>
        <h3>永久素材管理&nbsp;<a href="http://mp.weixin.qq.com/wiki/5/963fc70b80dc75483a271298a76a8d59.html" target="_blank">微信开发者文档</a></h3>
        <h4 style="color: red;">提示：<asp:Literal runat="server" ID="ltrMessage" Text="本示例演示永久素材管理。临时素材管理请看基础接口。" /></h4>
        <p>
            请选择公众号：
