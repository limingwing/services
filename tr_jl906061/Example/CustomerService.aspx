...
<body>
    <form id="form1" runat="server">
        <div>
            <h3>多客服接口&nbsp;<a href="http://mp.weixin.qq.com/wiki/7/12a5a320ae96fecdf0e15cb06123de9f.html" target="_blank">微信开发者文档</a></h3>
            <h4 style="color: red;">提示：<asp:Literal runat="server" ID="ltrMessage" Text="多客服接口未经充分测试。（必须先添加多客服功能，如底部截图所示；）" /></h4>
            <p>
                请选择公众号：
