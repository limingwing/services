<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserManagement.aspx.cs" Inherits="Example_UserManagement" %>
...
<body>
    ...
    <div>
        <h3>用户管理&nbsp;<a href="http://mp.weixin.qq.com/wiki/13/be5272dc4930300ba561d927aead2569.html" target="_blank">微信开发者文档</a></h3>
        <h4 style="color: red;">提示：<asp:Literal runat="server" ID="ltrMessage" Text="本示例演示用户管理的使用。" /></h4>
        <p>
            请选择公众号：
