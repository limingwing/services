...
public partial class Example_Meterial : WechatBasePage
{
    ...
    protected void btnGetCount_Click(object sender, EventArgs e)
    {
        string userName = lbPublicAccount.SelectedValue;
        ErrorMessage errorMessage;
        MeterialCount count = Meterial.GetMeterialCount(userName, out errorMessage);
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        ErrorMessage errorMessage = Meterial.Delete(userName, mediaId);
    ...
    protected void btnGet_Click(object sender, EventArgs e)
    {
        ...
        string mediaId = lbMeterial.SelectedValue;
        ErrorMessage errorMessage;
        byte[] bytes = Meterial.Get(userName, mediaId, out errorMessage);
