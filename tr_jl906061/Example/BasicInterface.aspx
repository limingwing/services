...
<body>
    <form id="form1" runat="server">
        <div>
            <h3>基础接口&nbsp;<a href="http://mp.weixin.qq.com/wiki/11/0e4b294685f817b95cbed85ba5e82b8f.html" target="_blank">微信开发者文档</a></h3>
            <h4 style="color: red;">提示：<asp:Literal runat="server" ID="ltrMessage" Text="本示例演示了基础接口的用法，包括：许可令牌、微信服务器地址、上传下载多媒体文件、创建二维码、长链接转短链接。" /></h4>
            <p>
                请选择公众号：
            ...
            <p>
                <h5>长链接转短链接</h5>
                长链接：<asp:TextBox runat="server" ID="txtLongUrl" Text="http://www.zizaifan.com/" /><br />
