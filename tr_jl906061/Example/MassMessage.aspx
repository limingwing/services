...
<body>
    ...
    <div>
        <h3>群发消息&nbsp;<a href="http://mp.weixin.qq.com/wiki/15/5380a4e6f02f2ffdc7981a8ed7a40753.html" target="_blank">微信开发者文档</a></h3>
        <h4 style="color: red;">提示：<asp:Literal runat="server" ID="ltrMessage" Text="本示例演示群发消息的使用。" /></h4>
        <p>
            请选择公众号：
