<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DataStatistics.aspx.cs" Inherits="Example_DataStatistics" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <h3>数据统计接口&nbsp;<a href="http://mp.weixin.qq.com/wiki/3/ecfed6e1a0a03b5f35e5efac98e864b7.html" target="_blank">微信开发者文档</a></h3>
            <h4 style="color: red;">提示：<asp:Literal runat="server" ID="ltrMessage" Text="本示例演示数据统计接口的使用。" /></h4>
            <p>
                请选择公众号：
