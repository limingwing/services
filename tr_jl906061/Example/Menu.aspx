...
<body>
    ...
    <div>
        <h3>自定义菜单&nbsp;<a href="http://mp.weixin.qq.com/wiki/13/43de8269be54a0a6f64413e4dfa94f39.html" target="_blank">微信开发者文档</a></h3>
        <h4 style="color: red;">提示：<asp:Literal runat="server" ID="ltrMessage" Text="本示例演示自定义菜单的使用。如果您删除了菜单，请在离开之前，点击“创建”按钮，多谢。" /></h4>
        <p>
            请选择公众号：
