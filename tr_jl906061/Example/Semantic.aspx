<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Semantic.aspx.cs" Inherits="Example_Semantic" %>
...
<body>
    ...
    <div>
        <h3>语义理解接口&nbsp;<a href="http://mp.weixin.qq.com/wiki/0/0ce78b3c9524811fee34aba3e33f3448.html" target="_blank">微信开发者文档</a></h3>
        <h4 style="color: red;">提示：<asp:Literal runat="server" ID="ltrMessage" Text="" /></h4>
