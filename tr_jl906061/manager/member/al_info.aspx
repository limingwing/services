<%@ Page Language="C#" AutoEventWireup="true" CodeFile="al_info.aspx.cs" Inherits="manager_member_al_info" %>
...
<body>
    ...
    <div class="itab">
     <ul> 
    <li><a href="#" class="selected">修改资料</a></li> 
  ...
  <dl>
    ...
    <span class="rule-single-select">
        <asp:DropDownList ID="DropDownList1" runat="server">
            ...
            <asp:ListItem Value="1">业务经理</asp:ListItem>
            <asp:ListItem Value="2">一星业务经理</asp:ListItem>
            <asp:ListItem Value="3">二星业务经理</asp:ListItem>
            <asp:ListItem Value="4">三星业务经理</asp:ListItem>
        </asp:DropDownList> 
    </span>
    <span class="Validform_checktip">*</span>
     </dd>
