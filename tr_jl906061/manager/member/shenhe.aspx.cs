...
public partial class manager_member_shenhe : System.Web.UI.Page
{
    protected int page;
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        if (action == "Edit") //修改
        {
            ...
            Page.ClientScript.RegisterClientScriptBlock(Page.GetType(), "", "window.parent.frames.location.href='shenhe.aspx' ", true);
            return;
        }
        else //发生错误
        {
