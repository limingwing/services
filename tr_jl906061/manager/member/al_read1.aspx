<%@ Page Language="C#" AutoEventWireup="true" CodeFile="al_read1.aspx.cs" Inherits="manager_member_al_read1" %>
...
<body>
    ...
    <div class="rightinfo">
        <dl class="seachform">
            ...
            <dd>
                <label>
                    注册开始日期</label><span class="single-select"><input type="text" class="timeinput" id="txtstart_time"
                        name="txtstart_time" readonly="readonly" runat="server" /></span></dd>
            <dd>
                <label>
                    注册结束日期</label><span class="single-select"><input type="text" class="timeinput" id="txtstop_time"
            ...
            <dd>
                ...
                <span class="rule-single-select">
                    <asp:DropDownList ID="ddlproduct_category_id" runat="server" AutoPostBack="True"
                        OnSelectedIndexChanged="ddlproduct_category_id_SelectedIndexChanged">
                    </asp:DropDownList>
                </span>
            </dd>
            <dd class="cx">
            ...
            <ItemTemplate>
                <tr>
                  ...
                  <%--  <td>
                    ...
                    <td>
                        <font runat="server" visible='<%#!new tbl_huiyuan().show_is(Convert.ToString(Eval("huiyuan_id")))%>'
                            color="red">不能删除</font>
                        <asp:LinkButton ID="LinkButton2" runat="server" OnClick="delete_Click1" OnClientClick="return confirm('是否真的要删除？')"
                            ...
                            CommandArgument='<%# Eval("huiyuan_id")%>'><font color=red>[删除]</font></asp:LinkButton>&nbsp;&nbsp;<asp:LinkButton
                                ID="LinkButton3" Visible="true" runat="server" OnClick="kd_kaitong" CommandArgument='<%# Eval("huiyuan_id")%>'><font color=red>[空单]</font></asp:LinkButton>
                        <%--&nbsp;&nbsp;<asp:LinkButton ID="LinkButton1" runat="server" OnClick="Open_Click"
                            CommandArgument='<%# Eval("huiyuan_id")%>'><font color=green>[开通]</font></asp:LinkButton>--%>
                            <a href="javascript:opdg('info','shenhe1.aspx?action=Edit&id=<%# Eval("huiyuan_id")%>');" class="tablelink">[审核]</a>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
