<%@ Page Language="C#" AutoEventWireup="true" CodeFile="no_supplier.aspx.cs" Inherits="manager_member_no_supplier" %>
...
<body>
    ...
    <div class="rightinfo">
        <dl class="seachform">
            ...
            <dd>
                <label>
                    结束日期</label><span class="single-select"><input type="text" class="timeinput" id="txtstop_time"
        ...
        <asp:Repeater ID="rptList" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <%#string.Format("{0:g}", Eval("ApplyTime"))%>
                    </td>
                    <td>
                        <%--<asp:LinkButton ID="LinkButton1" runat="server"><font color=red>[审核]</font></asp:LinkButton>--%>
                        <a href="javascript:opdg('info','shenhe.aspx?action=Edit&id=<%# Eval("id")%>');" class="tablelink">[审核]</a>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
