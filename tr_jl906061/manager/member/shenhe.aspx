<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shenhe.aspx.cs" Inherits="manager_member_shenhe" %>
...
<body>
    ...
    <div class="formbody">
        <div id="usual1" class="usual">
            <div class="itab">
                <ul>
                    <li><a href="#" class="selected">审核商家资料</a></li>
                </ul>
            </div>
            <!--修改信息-->
        ...
        <div class="page-footer">
            <div class="btn-list">
                <asp:Button ID="btnSubmit" runat="server" Text="开通" CssClass="btn" OnClick="btnSubmit_Click"
                    OnClientClick="return confirm('确定要开通此商家吗？');" />&nbsp;
                <asp:Button ID="Button1" runat="server" Text="取消资格" CssClass="btn" 
                    OnClientClick="return confirm('确定要取消资格吗？');" onclick="Button1_Click" />
            </div>
            <div class="clear">
            </div>
        </div>
