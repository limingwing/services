<%@ Page Language="C#" AutoEventWireup="true" CodeFile="al_read5.aspx.cs" Inherits="manager_member_al_read5" %>
...
<HeaderTemplate>
    <table class="tablelist">
		...
		<th width="160px;">会员手机</th>
 
          <th width="160px;">冻结金额</th>
       <th width="160px;">冻结前银行</th>
        <th width="160px;">冻结前账号</th>
        <th width="160px;">出网时间</th>
       
 
		<th width="200px;">抢点人</th>
        ...
        <tr>
            ...
            <td><%# Eval("huiyuan_bianhao")%> </td>
             ...
             <td><%# Eval("huiyuan_mob")%></td>	
                 ...
                 <td><%# Eval("dongjie_money")%>	</td>
               <td><%# Eval("huiyuan_yinhang")%>	</td>
               <td><%# Eval("huiyuan_yinhang_zh")%>	</td>
            <td><%#string.Format("{0:g}", Eval("qiangdian_date"))%></td>
         
 	     <td><%# Eval("qiang_bianhao")%></td>		
