<%@ Page Language="C#" AutoEventWireup="true" CodeFile="all_supplier.aspx.cs" Inherits="manager_member_all_supplier" %>
        ...
        <asp:Repeater ID="rptList" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <%--<asp:LinkButton runat="server"><font color=green>[修改]</font></asp:LinkButton>--%>
                        <a href="suppler_edit.aspx?action=Edit&id=<%#Eval("id")%>"><font color=green>[修改]</font></a>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
