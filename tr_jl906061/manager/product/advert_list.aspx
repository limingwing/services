<%@ Page Language="C#" AutoEventWireup="true" CodeFile="advert_list.aspx.cs" Inherits="manager_product_advert_list" %>
...
<HeaderTemplate>
    <table class="tablelist">
    	...
    	<tr>
        <th width="50px;">序号</th>
        <th width="50px;">广告标题</th>
        <th width="50px;">广告图</th>
...
<ItemTemplate> 
		...
		<td><a href="advert_edit.aspx?action=Edit&id=<%#Eval("id")%>&page=<%=page%>" class="tablelink"><font color =green>[修改]</font></a> </td>
        </tr> 
     </ItemTemplate>
<FooterTemplate>
