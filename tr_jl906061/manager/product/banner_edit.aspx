<%@ Page Language="C#" AutoEventWireup="true" CodeFile="banner_edit.aspx.cs" Inherits="manager_product_banner_edit" %>
...
<body>
    ...
    <li><a href="#">编辑 轮播图管理</a></li>
    </ul>
    </div>

    <div class="formbody">   
    <div class="formtitle"><span> 轮播图管理</span></div>
    <!--/ 类别管理-->
