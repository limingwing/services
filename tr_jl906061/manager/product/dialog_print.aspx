<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dialog_print.aspx.cs" Inherits="manager_product_dialog_print" %>
...
下单时间：<%= Convert.ToDateTime(model.add_time).ToString()%></td>
  <td width="220">操&nbsp; 作 人：<%= Session["hy_bianhao"].ToString()%><br />打印时间：<%=DateTime.Now%></td>
</tr>
<tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="5" style="font-size:12px; font-family:'微软雅黑'; background:#fff;">
          <tr>
           <td width="18%" align="left" style="background:#ccc;">商品类别</td>
            ...
            <td width="12%" align="left" style="background:#ccc;">会员价</td>
...
<tr>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="5" style="margin:5px auto; font-size:12px; font-family:'微软雅黑'; background:#fff;">
    ...
    <tr>
      <td>会员名称：<asp:Label ID="title" runat="server" /></td>
      <td>会员地址：<asp:Label ID="contact_address" runat="server" /></td>
    </tr>
    <tr>
      <td valign="top">
        用户留言：<%=model.message%>
    ...
    <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" style="border-top:1px solid #000; font-size:12px; font-family:'微软雅黑'; background:#fff;">
      <tr>
        <td align="right">订购商品金额：￥<%=model.payable_amount%> + 价格调整金额：￥<%=model.real_amount%>  = 实际PV总额：<%=model.order_amount%></td>
      </tr>
    </table></td>
  </tr>
</table>
