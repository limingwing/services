<%@ Page Language="C#" AutoEventWireup="true" CodeFile="erweima.aspx.cs" Inherits="manager_product_erweima" %>
...
<ItemTemplate> 
		...
		<td><a href="erweima_edit.aspx?action=Edit&id=<%#Eval("id")%>&page=<%=page%>" class="tablelink"><font color =green>[修改]</font></a>  </td>
        </tr> 
     </ItemTemplate>
<FooterTemplate>
