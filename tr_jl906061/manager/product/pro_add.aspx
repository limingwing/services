<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pro_add.aspx.cs" Inherits="manager_product_pro_add" %>
        ...
        <div id="usual1" class="usual">
            ...
            <div class="tab-content">
                ...
                <dl>
                    ...
                    <dd>
                        <span class="rule-single-select">
                            <asp:DropDownList ID="ddlprov" runat="server" datatype="*" 
                            errormsg="请选择商品产地" sucmsg=" " 
                            onselectedindexchanged="ddlprov_SelectedIndexChanged" AutoPostBack="true">
                            </asp:DropDownList>
                        </span><span class="rule-single-select">
                            <asp:DropDownList ID="ddlcity" runat="server" datatype="*" 
                            errormsg="请选择商品产地" sucmsg=" " 
                ...
                <dl>
                    ...
                    <dd>
                        <asp:TextBox ID="txtgo_price" runat="server" CssClass="input small" onkeyup="clearNoNum(this)"
                            MaxLength="8" datatype="*" sucmsg="" errormsg="请输入正确的金额" Width="49px"></asp:TextBox>&nbsp;&nbsp;元
                        <span class="Validform_checktip">*</span></dd>
                </dl>
                <dl>
                    <dt>销售单价</dt>
