...
public partial class manager_product_banner_list : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        mym.JscriptMsg(this.Page, " 排序保存成功", Utils.CombUrlTxt("banner_list.aspx", "keywords={0}&page={1}", this.keywords, this.page.ToString()), "Success");
    }
}