...
public partial class manager_product_advert_list : System.Web.UI.Page
{
    ...
    protected void lbtnDelCa_Click(object sender, EventArgs e)
    {
        ...
        if (!bllpp.ExistsBM())//查找是否存在下级商品
        {
            ...
            mym.JscriptMsg(this.Page, " 成功删除商品类别：" + pro_class + "", Utils.CombUrlTxt("advert_list.aspx", "keywords={0}&page={1}", this.keywords, this.page.ToString()), "Success");
        }
        else
        {
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        mym.JscriptMsg(this.Page, " 排序保存成功", Utils.CombUrlTxt("advert_list.aspx", "keywords={0}&page={1}", this.keywords, this.page.ToString()), "Success");
    }
}