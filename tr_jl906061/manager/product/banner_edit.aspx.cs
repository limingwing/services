...
public partial class manager_product_banner_edit : System.Web.UI.Page
{
    protected int page;
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        if (action == "Edit") //修改
        {
            ...
            mym.JscriptMsg(this.Page, "修改信息成功！", Utils.CombUrlTxt("banner_list.aspx", "page={0}", this.page.ToString()), "Success");
        }
        else //添加
        {
            if (!DoAdd())
            ...
            mym.JscriptMsg(this.Page, "添加产品类别信息成功！", "banner_list.aspx", "Success");
        }
    }
}