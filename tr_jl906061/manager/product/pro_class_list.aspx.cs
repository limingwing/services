...
public partial class manager_product_pro_class_list : System.Web.UI.Page
{
    ...
    protected string CombSqlTxt(string _keywords)
    {
        ...
        {
            strTemp.Append(" pro_class like  '%" + _keywords + "%' ");
        }
    ...
    {
        Response.Redirect(Utils.CombUrlTxt("pro_class_list.aspx", "keywords={0}", txtKeywords.Text));
    }
    ...
    protected void txtPageNum_TextChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect(Utils.CombUrlTxt("pro_class_list.aspx", "keywords={0}", this.keywords));
    }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        mym.JscriptMsg(this.Page, " 排序保存成功", Utils.CombUrlTxt("pro_class_list.aspx", "keywords={0}&page={1}", this.keywords, this.page.ToString()), "Success");
    }
}