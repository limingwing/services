<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bank.aspx.cs" Inherits="manager_system_bank" %>
...
<body>
    ...
    <div class="tools">   
    	<ul class="toolbar">
        <a href="bank_edit.aspx?action=Add"><li><span><img src="../../images/t01.png" /></span>添加</li></a>
...
<HeaderTemplate>
    <table class="tablelist">
		...
		<th width="50px;">开户姓名</th>
		<th width="50px;">银行帐号</th>
...
<ItemTemplate> 
        ...
        <td><a href="bank_edit.aspx?action=Edit&id=<%#Eval("id")%>&page=<%=page%>" class="tablelink"><font color =green>[修改]</font></a>  &nbsp;&nbsp;<asp:LinkButton ID="lbtnDelCa" runat="server" CommandArgument='<%# Eval("id")%>' OnClientClick="return confirm('是否真的要删除？')" onclick="lbtnDelCa_Click"><font color =red>[删除]</font></asp:LinkButton></td>
