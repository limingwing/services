<%@ Page Language="C#" AutoEventWireup="true" CodeFile="login_hy.aspx.cs" Inherits="manager_system_login_hy" %>
...
<ItemTemplate> 
      ...
      <asp:HiddenField ID="hidId" Value='<%#Eval("id")%>' runat="server" /></td>
        ...
        <td><a href="login_hy.aspx?keywords=<%# Eval("huiyuan_bianhao") %>"><%# Eval("huiyuan_bianhao")%></a></td>
	   <td><a href="login_hy.aspx?keywords=<%# Eval("huiyuan_name") %>"><%# Eval("huiyuan_name")%></a></td>
