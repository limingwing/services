...
public partial class manager_server_Service_Centre_un : System.Web.UI.Page
{
    ...
    private void RptBind(string _strWhere, string _orderby)
    {
        ...
        string pageUrl = Utils.CombUrlTxt("Service_Centre_un.aspx", "huiyuan_jiebie={0}&note_no={1}&page={2}&type={3}",   this.jiebie.ToString(), this.note_no, "__id__", this.cha_type.ToString());
    ...
    {
        Response.Redirect(Utils.CombUrlTxt("Service_Centre_un.aspx", "huiyuan_jiebie={0}&note_no={1}&type={2}",   this.ddlproduct_category_id.SelectedValue, txtNote_no.Text, this.type.SelectedValue));
    }

    //筛选会员级别
    protected void ddlproduct_category_id_SelectedIndexChanged(object sender, EventArgs e)
    {
        Response.Redirect(Utils.CombUrlTxt("Service_Centre_un.aspx", "huiyuan_jiebie={0}&note_no={1}",  this.ddlproduct_category_id.SelectedValue, txtNote_no.Text));
    ...
    protected void lbtnDelCa_Click(object sender, EventArgs e)
    {
        ...
        mym.JscriptMsg(this.Page, " 成功解除用户名（账号）：" + title + "的服务中心资格！", Utils.CombUrlTxt("Service_Centre_un.aspx", "huiyuan_jiebie={0}&note_no={1}&type={2}",  this.ddlproduct_category_id.SelectedValue, txtNote_no.Text, this.type.SelectedValue), "Success");
