<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Service_Centre_open.aspx.cs" Inherits="manager_server_Service_Centre_open" %>
...
<HeaderTemplate>
    <table class="tablelist">
        ...
        <%--<th width="160px;">专卖级别</th>--%>
        <th width="160px;">推荐人</th>
        <%--<th width="160px;">下属平级人数</th>
      	<th width="100px;">查看平级</th>--%>
...
<ItemTemplate> 
        <tr>
           ...
           <%--<td><%#Getstatus(Eval("huiyuan_id").ToString(),Eval("zhuanmai_jb").ToString())%></td>
             <td> <a href="javascript:opdg('info','show.aspx?id=<%#Eval("huiyuan_id")%>&jb=<%#Eval("zhuanmai_jb")%>');" class="tablelink">查看</a> </td>--%>
         	 
           
            
            <td> <asp:LinkButton ID="lbtnDelCa" runat="server" CommandArgument='<%# Eval("huiyuan_id")%>' OnClientClick="return confirm('是否真的要删除资格吗？')" onclick="lbtnDelCa_Click"><font color =red>[取消资格]</font></asp:LinkButton>&nbsp;&nbsp; </td>
        </tr> 
