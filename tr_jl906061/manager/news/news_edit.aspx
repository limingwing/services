<%@ Page Language="C#" AutoEventWireup="true" CodeFile="news_edit.aspx.cs" Inherits="manager_news_news_edit" %>
   ...
   <dl >
    ...
    <dd>
      <div class="rule-single-checkbox">
          <asp:CheckBox ID="is_show" runat="server" Checked=false />
      </div>
      <span class="Validform_checktip">*启用时商城首页可以看到该新闻</span>
    </dd>
  </dl>
  <dl>
    <dt>排序数字</dt>
