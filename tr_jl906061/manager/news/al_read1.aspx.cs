...
public partial class manager_news_al_read1 : System.Web.UI.Page
{
    ...
    private void RptBind(string _strWhere, string _orderby)
    {
        ...
        string pageUrl = Utils.CombUrlTxt("al_read1.aspx", "keywords={0}&page={1}", this.keywords, "__id__");
    ...
    {
        Response.Redirect(Utils.CombUrlTxt("al_read1.aspx", "keywords={0}", txtKeywords.Text));
    }
    ...
    protected void txtPageNum_TextChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect(Utils.CombUrlTxt("al_read1.aspx", "keywords={0}", this.keywords));
    }
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
      ...
      //  mym.AddAdminLog("删除", "删除公告成功" + sucCount + "条，失败" + errorCount + "条"); //记录日志
        mym.JscriptMsg(this.Page, " 删除公告成功" + sucCount + "条，失败" + errorCount + "条", Utils.CombUrlTxt("al_read1.aspx", "keywords={0}&page={1}", this.keywords, this.page.ToString()), "Success");
    }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        mym.JscriptMsg(this.Page, " 排序保存成功", Utils.CombUrlTxt("al_read1.aspx", "keywords={0}&page={1}", this.keywords, this.page.ToString()), "Success");
    }
}