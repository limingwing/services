<%@ Page Language="C#" AutoEventWireup="true" CodeFile="al_read1.aspx.cs" Inherits="manager_news_al_read1" %>
...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <a href="news_edit.aspx?action=Add"><li><span><img src="../../images/t01.png" /></span>添加</li></a>
    ...
    <dl class="seachform">
       <dd><label>公告标题</label><span class="single-select"><asp:TextBox ID="txtKeywords" runat="server" CssClass="scinput" Width="300"></asp:TextBox></span></dd>
...
<ItemTemplate> 
      ...
      <asp:HiddenField ID="hidId" Value='<%#Eval("id")%>' runat="server" /></td>
		...
		<td><%# Eval("title")%></td>
		<td><%#string.Format("{0:g}", Eval("news_date"))%></td>
	    ...
	    <td><a href="news_edit.aspx?action=Edit&id=<%#Eval("id")%>&page=<%=page%>" class="tablelink"><font color =green>[修改]</font></a>  &nbsp;&nbsp;<asp:LinkButton ID="lbtnDelCa" runat="server" CommandArgument='<%# Eval("id")%>' OnClientClick="return confirm('是否真的要删除？')" onclick="lbtnDelCa_Click"><font color =red>[删除]</font></asp:LinkButton></td>
        </tr> 
  </ItemTemplate>
<FooterTemplate>
