<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jiangjinmx.aspx.cs" Inherits="manager_yeji_jiangjinmx" %>
...
<body>
    ...
    <table class="tablelist">
        ...
        <th  width="100px;">得奖人</th>	
        <th  width="100px;">得奖人级别</th>	
		<th  width="100px;">发奖人</th>	
        <th  width="100px;">发奖人级别</th>	
        <th  width="100px;">奖金</th>
	
        <th width="100px;">类型</th> 
        <th width="100px;">结算时间</th>
...
<ItemTemplate> 
        <tr>
            ...
            <td><%#getname(Eval("xiaofei_hui_id").ToString())%></td>
            <td><%#new tbl_reg_jiebie().GetTitle(getjb(Eval("xiaofei_hui_id").ToString()))%></td>
            <td><%#getname(Eval("xiaofei_ju").ToString())%></td>
            <td><%#new tbl_reg_jiebie().GetTitle(getjb(Eval("xiaofei_ju").ToString()))%></td>
            <td><%#money_Convert(Eval("xiaofei_money").ToString())%></td>
            <td><%#getlei(Eval("xiaofei_type").ToString())%></td>
            <td><%#string.Format("{0:g}", Eval("xiaofei_date"))%></td>
