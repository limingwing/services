...
public partial class manager_stock_sell_list : System.Web.UI.Page
{
    ...
    protected string CombSqlTxt(string _note_no, string _start_time, string _stop_time, int cha_type)
    {
        ...
        strTemp.Append(" and  sell_date between  '" + DateTime.Parse(_start_time) + "' and '" + DateTime.Parse(_stop_time + " 23:59:59") + "'");
    ...
    {
        Response.Redirect(Utils.CombUrlTxt("sell_list.aspx", "start_time={0}&stop_time={1}&note_no={2}&type={3}", this.txtstart_time.Value, this.txtstop_time.Value, txtNote_no.Text, this.type.SelectedValue));
    }
