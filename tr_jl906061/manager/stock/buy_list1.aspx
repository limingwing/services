<%@ Page Language="C#" AutoEventWireup="true" CodeFile="buy_list1.aspx.cs" Inherits="manager_stock_buy_list1" %>
            ...
            <thead>
                <tr>
                   ...
                   <th width="100px">
                    ...
                    <th width="100px">
                        买入总金额<font color="red">(总累计:<asp:Literal ID="Literal_hj" runat="server"></asp:Literal>)
                    </th>
                    <th width="100px">
                        订单编号
                    </th>
                ...
                <asp:Repeater ID="rptList" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <%#string.Format("{0:g}", Eval("cj_date"))%>
                            </td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
