...
public partial class manager_mail_out_box : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            RptBind("liuyan_bianhao='A00000000'" + CombSqlTxt(this.keywords), "id desc");
        }
    }
    ...
    protected string CombSqlTxt(string _keywords)
    {
        ...
        {
            strTemp.Append(" and (liuyan_to like  '%" + _keywords + "%' or liuyan_to_name like '%" + _keywords + "%'   )");
        }
    ...
    {
        Response.Redirect(Utils.CombUrlTxt("out_box.aspx", "keywords={0}", txtKeywords.Text));
    }
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        mym.JscriptMsg(this.Page, " 删除用户操作日志成功" + sucCount + "条，失败" + errorCount + "条", Utils.CombUrlTxt("out_box.aspx", "keywords={0}&page={1}", this.keywords, this.page.ToString()), "Success");
    }
