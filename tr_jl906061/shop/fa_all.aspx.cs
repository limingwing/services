...
using System.Data;
public partial class shop_fa_all : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            RptBind(" a.sid in (select sid from tbl_huiyuan where huiyuan_id='" + Session["hy_id1"].ToString() + "')", "add_time desc");//绑定订单
    ...
    private void RptBind(string _strWhere, string _orderby)
    {
        ...
        string pageUrl = Utils.CombUrlTxt("fa_all.aspx", "page={0}", "__id__");
    ...
    {
        int _pagesize;
        if (int.TryParse(Utils.GetCookie("fa_all_page_size"), out _pagesize))
        {
