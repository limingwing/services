<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zhifubao.aspx.cs" Inherits="shop_zhifubao" %>
			...
			<div class="col-main">
				<div class="main-wrap">
					<div class="am-cf am-padding">
						<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">支付宝充值</strong> / <small>Alipay recharge</small></div>
					</div>
					<hr>
					 <div class="am-form" >
