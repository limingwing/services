...
public partial class shop_rewardcashlist : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            RptBind(" huiyuan_id='" + Session["hy_id1"].ToString() + "' ", "tikuan_id desc");
        }
    }
    ...
    private void RptBind(string _strWhere, string _orderby)
    {
        ...
        string pageUrl = Utils.CombUrlTxt("rewardcashlist.aspx", "page={0}", "__id__");
