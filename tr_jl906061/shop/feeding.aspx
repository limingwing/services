<%@ Page Language="C#" AutoEventWireup="true" CodeFile="feeding.aspx.cs" Inherits="shop_feeding" %>
            ...
            <div class="main-wrap">
                <div class="am-cf am-padding">
                    <div class="am-fl am-cf">
                        <strong class="am-text-danger am-text-lg">饲养宠物</strong> / <small></small></div>
                </div>
                <hr />
                <div class="am-form am-form-horizontal">
                    ...
                    <div class="am-form-group">
                        <label for="user-old-password" class="am-form-label">
                            宠物级别</label>
                        <div class="am-form-content">
                            <asp:DropDownList id="huiyuan_jiebie" runat="server" datatype="*" errormsg="请选择会员宠物" sucmsg=" " ></asp:DropDownList>  
                        </div>
                    </div>
                    <%--<div class="am-form-group">
                        <label for="user-old-password" class="am-form-label" >
  ...
  <%#rptList.Items.Count == 0 ? "<tr><td align=\"center\" colspan=\"10\"><font color=red><font color=red>暂无记录</font></font></td></tr>" : ""%>
                    ...
                    <div class="info-btn">
                        <div class="am-btn am-btn-danger">
                            <asp:Button ID="btnSubmit" runat="server" Text="确认升级" class="am-btn am-btn-danger"
