<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zhuanzhang3.aspx.cs" Inherits="shop_zhuanzhang3" %>
            ...
            <div class="main-wrap">
                <div class="am-cf am-padding">
                    <div class="am-fl am-cf">
                        <strong class="am-text-danger am-text-lg">内盘转外</strong> / <small>Transform</small></div>
                </div>
                <hr />
                <div class="am-form am-form-horizontal">
                    ...
                    <div class="am-form-group">
                        <label for="user-old-password" class="am-form-label">
                            账户</label>
                        <div class="am-form-content">
                            <input name="zhuan_user" runat="server" type="text" id="zhuan_user" placeholder="请输入账户"/>
                        </div>
                    </div>
                    <div class="am-form-group">
                        <label for="user-old-password" class="am-form-label">
                            密码</label>
                        <div class="am-form-content">
                            <input name="zhuan_pwd" runat="server" type="password" id="zhuan_pwd" placeholder="请输入密码"/>
                        </div>
                    </div>
                    <div class="am-form-group">
                        <label for="user-old-password" class="am-form-label">
                            金额</label>
                        <div class="am-form-content">
                            <input name="zhuan_money" runat="server" type="text" id="zhuan_money" placeholder="请输入金额"/>
                        </div>
                    </div>
                    <div class="am-form-group">
                        <label for="user-old-password" class="am-form-label">
                    ...
                    <div class="info-btn">
                        <div class="am-btn am-btn-danger">
                            <asp:Button ID="btnSubmit" runat="server" Text="确认转外" class="am-btn am-btn-danger"
