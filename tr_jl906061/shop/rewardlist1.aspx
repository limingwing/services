<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rewardlist1.aspx.cs" Inherits="shop_rewardlist1" %>
...
<div style="overflow:auto;">
					<table width="95%" align="center" style=" margin-left:25px;">
						...
						<thead >
							<tr>
                                ...
                                <th  style="border:1px solid #666;">发奖人</th>
                                <th style="border:1px solid #666;">积分</th>
                                <th  style="border:1px solid #666;">积分类型</th>
                    ...
                    <ItemTemplate> 
                     <tr>
                       ...
                       <td style="border:1px solid #666;"><%#getname( Eval("xiaofei_ju").ToString())%></td>
                       <td style="border:1px solid #666;"><%#money_Convert(Eval("xiaofei_money").ToString())%></td>
                       <td style="border:1px solid #666;"><%#getlei(Eval("xiaofei_type").ToString())%></td>
