<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rewardguquan.aspx.cs" Inherits="shop_rewardguquan" %>
            ...
            <div class="main-wrap">
                <div class="am-cf am-padding">
                    <div class="am-fl am-cf">
                        <strong class="am-text-danger am-text-lg">购买期权</strong> / <small>Password</small></div>
                </div>
                <hr />
                <div class="am-form am-form-horizontal">
                    ...
                    <div class="am-form-group">
                        <label for="user-old-password" class="am-form-label">
                            购买金额</label>
                        <div class="am-form-content">
                            <input name="money" runat="server" type="text" id="money" placeholder="最多肽豆的10%" />
                        </div>
                    </div>
                    <div class="am-form-group">
                        <label for="user-old-password" class="am-form-label">
                    ...
                    <div class="info-btn">
                        <div class="am-btn am-btn-danger">
                            <asp:Button ID="btnSubmit" runat="server" Text="确认购买" class="am-btn am-btn-danger"
                                ...
                                <div class="am-btn am-btn-danger">
                            <asp:Button ID="Button1" runat="server" Text="自动购买" class="am-btn am-btn-danger"
                                OnClick="btnSubmit_Click2" ValidationGroup="a" /></div>
