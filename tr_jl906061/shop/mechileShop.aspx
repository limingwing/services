<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mechileShop.aspx.cs" Inherits="shop_mechileShop" %>
            ...
            <div class="main-wrap">
                <div class="am-cf am-padding">
                    <div class="am-fl am-cf">
                        <strong class="am-text-danger am-text-lg">购买打印机</strong> / <small></small></div>
                </div>
                <hr />
                <div class="am-form am-form-horizontal">
                    ...
                    <div class="am-form-group">
                        <label for="user-old-password" class="am-form-label">
                            级别</label>
                        <div class="am-form-content">
                            <asp:DropDownList id="huiyuan_jiebie" runat="server" datatype="*" errormsg="请选择打印机" sucmsg=" " ></asp:DropDownList>  
                        </div>
                    </div>
                    <%--<div class="am-form-group">
                        <label for="user-old-password" class="am-form-label" >
...
<HeaderTemplate>
     <table class="tablelist">
		...
		<th style="border:1px solid #666;" width="150px">商品名称</th>
		 ...
		 <th style="border:1px solid #666;" width="150px">商品类别</th>
...
<ItemTemplate> 
        <tr >
             ...
             <td style="border:1px solid #666; vertical-align: middle;"><%#new tbl_sinkia_sub().GetTitle_sub(Convert.ToInt32(Eval("pro_pid")))%></td>	      
  ...
  <%#rptList.Items.Count == 0 ? "<tr><td align=\"center\" colspan=\"10\"><font color=red><font color=red>暂无记录</font></font></td></tr>" : ""%>
                    ...
                    <div class="info-btn">
                        <div class="am-btn am-btn-danger">
                            <asp:Button ID="btnSubmit" runat="server" Text="确认购买" class="am-btn am-btn-danger"
