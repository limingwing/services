<%@ Page Language="C#" AutoEventWireup="true" CodeFile="order_shou.aspx.cs" Inherits="shop_order_shou" %>
														...
														<div class="move-right">
															...
															<li class="td td-change">
																<div class="am-btn am-btn-danger anniu">
																	 <asp:LinkButton ID="LinkButton2" runat="server"     OnClientClick="return confirm('确认要收到货物吗？');"  CommandArgument='<%# Eval("id")%>'  Visible=' <%#isshow(Convert.ToInt32(Eval("status")))%>'   OnClick="shouhuo"> 确认收货 </asp:LinkButton></div>
															</li>
														</div>
													</div>
												</div>
