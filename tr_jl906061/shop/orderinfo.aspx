<%@ Page Language="C#" AutoEventWireup="true" CodeFile="orderinfo.aspx.cs" Inherits="shop_orderinfo" %>
                                    ...
                                    <div class="order-right">
                                        ...
                                        <div class="move-right">
                                            ...
                                            <li class="td td-change">
                                                <div class="am-btn am-btn-danger anniu" runat="server">
                                                    <a href="#" onclick="javascript:top.location.href='pay.aspx?order_id=<%=model.id%>';"
                                                        style="color: White">一键支付</a>
                                                </div>
                                            </li>
                                            <%}%>
                                            <%if (model.status == 2)
                                            ...
                                            <li class="td td-change">
                                                <div class="am-btn am-btn-danger anniu" runat="server">
                                                    <asp:LinkButton ID="LinkButton1" runat="server" ForeColor="White" OnClientClick="return confirm('请在确实收到货后点击确认收货？');"
                                                        OnClick="LinkButton1_Click">确认收货</asp:LinkButton>
                                                </div>
                                            </li>
                                            <%}%>
                                        </div>
