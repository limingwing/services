<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zhuanzhang1.aspx.cs" Inherits="shop_zhuanzhang1" %>
        ...
        <div class="col-main">
            ...
            <div class="am-cf am-padding">
                    <div class="am-fl am-cf">
                        <strong class="am-text-danger am-text-lg">购买福利积分</strong> / <small>Walfare</small></div>
                </div>
                <hr />
                <div class="am-form am-form-horizontal">
                    ...
                    <div class="am-form-group">
                        <label for="user-old-password" class="am-form-label">
                            福利积分</label>
                        <div class="am-form-content">
                            <input name="zhuan_money" runat="server" type="text" id="zhuan_money" placeholder="请输入金额" readonly="readonly" />
                        </div>
                    </div>
                    <div class="am-form-group">
                        <label for="user-old-password" class="am-form-label">
