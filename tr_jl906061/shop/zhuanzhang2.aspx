<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zhuanzhang2.aspx.cs" Inherits="shop_zhuanzhang2" %>
            ...
            <div class="main-wrap">
                <div class="am-cf am-padding">
                    <div class="am-fl am-cf">
                        <strong class="am-text-danger am-text-lg">积分转换</strong> / <small>Transform</small></div>
                </div>
                <hr />
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-form-content">
                            <asp:DropDownList ID="zz_type" runat="server" class="form-control">
                                <asp:ListItem Value="1" Selected="True">购物积分转奖励积分</asp:ListItem>
                                <asp:ListItem Value="2">奖励积分转购物积分</asp:ListItem>
                             <%--   <asp:ListItem Value="3">消费佣金转肽豆</asp:ListItem>--%>
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="am-form-group">
