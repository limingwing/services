<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fa_add.aspx.cs" Inherits="shop_fa_add" %>
            ...
            <div class="main-wrap">
                <div class="am-cf am-padding">
                    <div class="am-fl am-cf">
                        <strong class="am-text-danger am-text-lg">发起留言</strong> / <small>Password</small></div>
                </div>
                <hr />
                <div class="am-form am-form-horizontal">
                    <div class="am-form-group">
                        ...
                        <div class="am-form-content">
                            <input name="liuyan_title" runat="server" type="text" id="liuyan_title" placeholder="主题" />
                        </div>
                    </div>
                    <div class="am-form-group">
                        <label for="user-old-password" class="am-form-label">
                            具体内容</label>
                        <div class="am-form-content">
                             <textarea name="liuyan_memo" runat=server id="liuyan_memo" style="width:97%;height: 60px;"></textarea>
                        </div>
                    </div>
                    <div class="am-form-group">
                        <label for="user-old-password" class="am-form-label">
                    ...
                    <div class="info-btn">
                        <div class="am-btn am-btn-danger">
                            <asp:Button ID="btnSubmit" runat="server" Text="确认" class="am-btn am-btn-danger"
