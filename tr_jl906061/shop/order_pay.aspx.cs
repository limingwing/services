...
public partial class shop_order_pay : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            RptBind("  user_id='" + Session["hy_id1"].ToString() + "' and payment_status=1", "add_time desc");//绑定订单
    ...
    protected void GetWhichCommand(object sender, CommandEventArgs e)
    {
        ...
        order.delectid(KindID);
        Response.Redirect("order_pay.aspx");
    }
}