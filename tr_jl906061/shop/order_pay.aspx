<%@ Page Language="C#" AutoEventWireup="true" CodeFile="order_pay.aspx.cs" Inherits="shop_order_pay" %>
														...
														<div class="move-right">
															<li class="td td-status">
																<div class="item-status">
																	...
																	<p class="order-info"><asp:LinkButton ID="LinkButton1" runat="server" OnCommand="GetWhichCommand" CommandArgument='<%# Eval("id")%>' CssClass="btn-go" 
                                                  OnClientClick="return confirm('确定要取消吗？');">取消订单</asp:LinkButton></p>

																</div>
															</li>
															<li class="td td-change">
                                                            <a href=# onclick="javascript:top.location.href='pay.aspx?order_id=<%# Eval("id")%>';" >
