<%@ Page Language="C#" AutoEventWireup="true" CodeFile="search1.aspx.cs" Inherits="shop_search1" %>
                                ...
                                <ItemTemplate>
                                    <li>
                                        <div class="i-pic limit">
                                            <a href="introduction.aspx?pro_id=<%# Eval("pro_id")%>&t=1">
                                            ...
                                            <p class="price fl">
                                                <b>¥</b> <strong>
                                                    <%# (Convert.ToDecimal(Eval("salse_price")) * 0.5m).ToString("n2")%></strong>
                                            </p>
                                            <p class="number fl">
