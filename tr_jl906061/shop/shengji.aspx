<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shengji.aspx.cs" Inherits="shop_shengji" %>
            ...
            <div class="main-wrap">
                <div class="am-cf am-padding">
                    <div class="am-fl am-cf">
                        <strong class="am-text-danger am-text-lg">会员升级</strong> / <small></small></div>
                </div>
                <hr />
                    ...
                    <div class="am-form-group">
                        <label for="user-old-password" class="am-form-label">
                            ...
                            <asp:DropDownList ID="zz_type" runat="server" class="form-control"  >
                                       ...
                                       <asp:ListItem Value=2>购物积分</asp:ListItem> 
                                                           </asp:DropDownList>
                            </div>
                    <div class="am-form-group">
                        <label for="user-old-password" class="am-form-label">
