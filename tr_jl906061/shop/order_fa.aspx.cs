...
public partial class shop_order_fa : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            RptBind("  user_id='" + Session["hy_id1"].ToString() + "' and payment_status=2 and status=1", "add_time desc");//绑定订单
    ...
    private void RptBind(string _strWhere, string _orderby)
    {
        ...
        string pageUrl = Utils.CombUrlTxt("order_fa.aspx", "page={0}", "__id__");
