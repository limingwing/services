...
public partial class shop_fa_send : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            RptBind(" a.sid in (select sid from tbl_huiyuan where huiyuan_id='" + Session["hy_id1"].ToString() + "') and a.payment_status=2 and a.status=1", "add_time desc");//绑定订单
    ...
    private void RptBind(string _strWhere, string _orderby)
    {
        ...
        string pageUrl = Utils.CombUrlTxt("fa_send.aspx", "page={0}", "__id__");
