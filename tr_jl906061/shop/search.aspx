<%@ Page Language="C#" AutoEventWireup="true" CodeFile="search.aspx.cs" Inherits="shop_search" %>
                ...
                <div class="am-u-sm-12 am-u-md-12">
                    <div class="theme-popover">
                        <div class="searchAbout">
                            <span class="font-pale">相关搜索：</span> <a title="坚果" href="#">坚果</a> <a title="瓜子"
                                href="#">瓜子</a> <a title="鸡腿" href="#">豆干</a>
                        </div>
                        <ul class="select">
                            <p class="title font-normal">
                                <span class="fl" runat="server" id="searchName" style="color: Red">松子</span> <span
                                    class="total fl">搜索到<strong class="num" runat="server" id="searchNum" style="color: Red">997</strong>件相关商品</span>
                            </p>
                            <div class="clear">
                            </div>
                            <li class="select-result" id="liclear" runat="server">
                                <dl>
                                    <dt>已选</dt>
                                    <dd class="select-no">
                                    </dd>
                            ...
                            <li class="select-list">
                                <dl id="select1">
                                    ...
                                    <div class="dd-conent" id="divProvince" runat="server">
                                    </div>
                                </dl>
                            </li>
                            <li class="select-list">
                                <dl id="select2">
                                    <dt class="am-badge am-round">城市</dt>
                                    <div class="dd-conent" id="divCity" runat="server">
                                    </div>
                                </dl>
                            </li>
                              <li class="select-list">
                                <dl id="select3">
                                    <dt class="am-badge am-round">区县</dt>
                                    <div class="dd-conent" id="divArea" runat="server">
                                    </div>
                                </dl>
                            </li>
                        </ul>
                                ...
                                <ItemTemplate>
                                    <li>
                                        <div class="i-pic limit">
                                            ...
                                            <p class="price fl">
                                                <b>¥</b> <strong>
                                                    <%# (Convert.ToDecimal(Eval("salse_price"))*1m).ToString("n2")%></strong>
                                            </p>
                                            <p class="number fl">
                                                销量<span><%# Eval("pro_sum")%></span>
                                            </p>
                                        </div>
                                    </li>
                                </ItemTemplate>
