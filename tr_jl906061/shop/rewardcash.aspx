<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rewardcash.aspx.cs" Inherits="shop_rewardcash" %>
            ...
            <div class="main-wrap">
                <div class="am-cf am-padding">
                    <div class="am-fl am-cf">
                        <strong class="am-text-danger am-text-lg">提现</strong> / <small>Reward Cash</small></div>
                </div>
                <hr />
                <div class="am-form am-form-horizontal">
                    ...
                    <div class="am-form-group">
                        <label for="user-old-password" class="am-form-label">
                            金额</label>
                        <div class="am-form-content">
                            <input name="money" runat="server" type="text" id="money" placeholder="请输入金额" /><%--平台维护费<asp:Label
                    ...
                    <div class="info-btn">
                        <div class="am-btn am-btn-danger">
                           <a class="am-btn am-btn-danger" onclick="submit('<%=canshu1 %>')">确认提现</a>
                            <asp:Button ID="btnSubmit" runat="server" Text="" class="am-btn am-btn-danger" OnClick="btnSubmit_Click1" ValidationGroup="a" style="display:none" /></div>
