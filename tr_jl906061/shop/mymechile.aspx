<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mymechile.aspx.cs" Inherits="shop_mymechile" %>
			...
			<div class="col-main">
				<div class="main-wrap">
					<div class="am-cf am-padding">
						<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">我的打印机</strong> / <small>Electronic&nbsp;bill</small></div>
					</div>
					<hr>
...
<div style="overflow:auto;">
					<table width="95%" align="center" style=" margin-left:10px;">

						<thead >
							<tr>
								<th  style="border:1px solid #666;">序号</th>
                                <th  style="border:1px solid #666;">打印机</th>
                                <th  style="border:1px solid #666;">周期</th>
                                <th  style="border:1px solid #666;">打印收益</th>
                                <th  style="border:1px solid #666;">购买日期</th>
							</tr>
						</thead>
                    ...
                    <ItemTemplate> 
                     <tr>
                       ...
                       <td style="border:1px solid #666;"><%#money_Convert(Eval("xiaofei_money").ToString())%></td>
                        <td style="border:1px solid #666;"><%#zhouqi_Convert(Eval("jiebie").ToString(), Eval("cishu").ToString())%></td>
                         <td style="border:1px solid #666;"><%#money_Convert(Eval("fh_money").ToString())%></td>
                       <td style="border:1px solid #666;"><%#string.Format("{0:m}", Eval("xiaofei_date"))%>  <%#string.Format("{0:t}",Eval("xiaofei_date"))%></td>
                    </tr> 
	                </ItemTemplate>
                    <FooterTemplate>
