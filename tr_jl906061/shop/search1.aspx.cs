...
using System.Text;
using System.Data;
public partial class shop_search1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            hot_pro_bind();
            RptBind("1=1 and pro_isok=1 and flag=0" + CombSqlTxt(this.pro_pid, this.pro_name.ToString()), "pro_id desc,pro_date desc");//绑定喜欢产品
        }
    ...
    private void RptBind(string _strWhere, string _orderby)
    {
        ...
        string pageUrl = Utils.CombUrlTxt("search1.aspx", "page={0}&pro_pid={1}&pro_name={2}", "__id__", this.pro_pid.ToString(), this.pro_name.ToString());
