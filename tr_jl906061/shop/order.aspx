<%@ Page Language="C#" AutoEventWireup="true" CodeFile="order.aspx.cs" Inherits="shop_order" %>
					...
					<div class="user-order">
						...
						<div class="am-tabs am-tabs-d2 am-margin" data-am-tabs>
							...
							<div class="am-tabs-bd">
							 ...
							 <iframe height="100%" width="100%" frameborder="0" name="center" src="order_all.aspx" id="mainFrame" onLoad="iFrameHeight()" >
                              </iframe>
                               ...
                               <script type="text/javascript" language="javascript">
                                ...
                                <iframe height="100%" width="100%" frameborder="0" name="center" src="order_fa.aspx" id="mainFrame2" onLoad="iFrameHeight2()" >
                              </iframe>
                               <script type="text/javascript" language="javascript">
