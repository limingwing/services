...
using System.Data.SqlClient;
	...
	/// </summary>
	[Serializable]
	public partial class tbl_admin_navi
	{
		public tbl_admin_navi()
		{}
		#region Model
		private int _id;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [tbl_admin_navi]");
			strSql.Append(" where id=@id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [tbl_admin_navi] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [tbl_admin_navi] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [tbl_admin_navi] ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
			parameters[0].Value = id;
