...
using System.Data.SqlClient;
	...
	/// <summary>
	/// 类tbl_admin_role_value。
	/// </summary>
	[Serializable]
	public partial class tbl_admin_role_value
	{
		public tbl_admin_role_value()
		{}
		#region Model
		private int _id;
		...
		/// 得到一个对象实体
		/// </summary>
		public tbl_admin_role_value(int id)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,role_id,nav_id ");
			strSql.Append(" FROM [tbl_admin_role_value] ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [tbl_admin_role_value]");
			strSql.Append(" where id=@id ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from tbl_admin_role_value where role_id=" + _role_id + " and nav_id=" + _nav_id + "");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [tbl_admin_role_value] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [tbl_admin_role_value] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [tbl_admin_role_value] ");
