...
public partial class cart_items
{
    ...
    private decimal _goprice = 0M;//原价
    private int _quantity = 1;
    private int _stock_quantity = 0;
    private int _product_category_id = 0;
    private string _shuxing;//属性
    private string _key_shuxing;//属性+key
    ...
    /// 商品属性+key
    /// </summary>
    public string key_shuxing
    {
        set { _key_shuxing = value; }
        get { return _key_shuxing; }
    }
