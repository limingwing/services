...
public class Utils
    {
        ...
        {
            string num = DateTime.Now.ToString("yyMMddHHmmss");//yyyyMMddHHmmssfff精确到毫秒级，减少并发
        ...
        private static string EncryptKey = "12345678"; //密钥向量
        ...
        {
            string num = "B" + DateTime.Now.ToString("yyMMddHHmmss");//yyyyMMddHHmmssfff精确到毫秒级，减少并发
            return num + Number(5).ToString();
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetsellNumber()
        {
            string num = "S" + DateTime.Now.ToString("yyMMddHHmmss");//yyyyMMddHHmmssfff精确到毫秒级，减少并发
            return num + Number(5).ToString();
        }
    }
