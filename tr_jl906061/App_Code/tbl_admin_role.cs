...
using System.Data.SqlClient;
	...
	public partial class tbl_admin_role
	{
        ...
        public string GetTitle(int id)
        {
            ...
            strSql.Append("select top 1 role_name from [tbl_admin_role]");
		...
		/// 得到一个对象实体
		/// </summary>
		public tbl_admin_role(int id)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,role_name,role_type,is_sys ");
			strSql.Append(" FROM [tbl_admin_role] ");
			strSql.Append(" where id=@id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [tbl_admin_role]");
			strSql.Append(" where id=@id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [tbl_admin_role] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [tbl_admin_role] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [tbl_admin_role] ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
			parameters[0].Value = id;
