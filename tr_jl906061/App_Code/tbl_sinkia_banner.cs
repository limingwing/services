...
[Serializable]
public partial class tbl_sinkia_banner
{
    public tbl_sinkia_banner()
    { }
    #region Model
    private int _id;
    ...
    /// 得到一个对象实体
    /// </summary>
    public tbl_sinkia_banner(int id)
    {
        StringBuilder strSql = new StringBuilder();
        strSql.Append("select id,picture1,p1_url,sort_id,beiyong1,beiyong2,beiyong3,beiyong4,beiyong5 ");
        strSql.Append(" FROM [tbl_sinkia_banner] ");
    ...
    {
        StringBuilder strSql = new StringBuilder();
        strSql.Append("select count(1) from [tbl_sinkia_banner]");
        strSql.Append(" where id=@id ");
    ...
    {
        StringBuilder strSql = new StringBuilder();
        strSql.Append("insert into [tbl_sinkia_banner] (");
        strSql.Append("picture1,p1_url,sort_id,beiyong1,beiyong2,beiyong3,beiyong4,beiyong5)");
        ...
        parameters[0].Value = picture1;
        parameters[1].Value = p1_url;
    ...
    {
        StringBuilder strSql = new StringBuilder();
        strSql.Append("update tbl_sinkia_banner set " + strValue);
        strSql.Append(" where id=" + id);
    ...
    {
        StringBuilder strSql = new StringBuilder();
        strSql.Append("update [tbl_sinkia_banner] set ");
    ...
    {
        StringBuilder strSql = new StringBuilder();
        strSql.Append("delete from [tbl_sinkia_banner] ");
        strSql.Append(" where id=@id ");
        SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
        parameters[0].Value = id;
    ...
    {
        StringBuilder strSql = new StringBuilder();
        strSql.Append("select * FROM  tbl_sinkia_banner");
        if (strWhere.Trim() != "")
        {
            strSql.Append(" where " + strWhere);
        }
